...
$(function () {
    ...
    $("#user-left-box img").mouseover(function (event) {
        $(this).attr("src", "/StyleResource/Image/Other/touxiang2.png");
    }).mouseleave(function () {
        $(this).attr("src", "/StyleResource/Image/Other/touxiang.png");
    }).click(function (event) {
        window.location.href = "/ProjectEngineering/Index";
    });
