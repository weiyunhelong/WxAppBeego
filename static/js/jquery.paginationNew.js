	...
	return this.each(function() {
		...
		function drawLinks() {
			...
			if (opts.isJump) {
			    ...
			    // Generate Jump Input
			    panel.append(jQuery("<a onclick='javascript:void();' style='border:none;padding: 0px;'><input type='text' style='text-align:left;width:35px;height:25px; ' id='jump-index' title='请输入正整数' size='1' /></a>"));
